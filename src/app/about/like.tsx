export default function Like() {
    return (
        ...
        >
            ...
            <div
            className="absolute text-green-500 font-bold -bottom-10 left-1/2 text-sm text-center whitespace-nowrap transition-all duration-300 transform -translate-x-1/2 group-hover:bottom-0"
            >
            Like
            </div>
        </div>
